...
import color_palette from '@amcharts/amcharts5/themes/Spirited';
...
export default {
    ...
    methods: {
        getData() {
            api.get('/mda_data/retests/').then(response => {
        ...
        getWeekData() {
            api.get('/mda_data/retests/week').then(response => {
                var data = response.data;
                this.week_data = data;
                this.drawChart()
            }).catch(err => {
        ...
        filterData(start_date, last_date) {
            api.get('/mda_data/retests/' + start_date + "/" + last_date).then(response => {
                var data = response.data;
