  ...
  <q-card-section>
    <div class="text-h6 q-pb-lg">
      <div class="row">
        ...
        <div class="col"></div>
        <div class="col-auto" v-if="this.current_user.rol == 'Administrador' || this.current_user.rol == 'M&C Full'">
          <q-btn color="positive" label="Registrar" @click="this.$refs.insertDialog.openDialog(id_maintenance)" />
        </div>
    ...
    <div class="row">
      <q-grid title="Historial de Maintenimientos" :data="data" :columns="columns" row-key="name" style="width: 100vw"
        :columns_filter="true">
