...
import IndividualOutput from './component/individualOutput.vue';
...
export default {
    ...
    methods: {
        getData() {
            ...
            api.get('/ict_data/activations/bb/input_output').then(response => {
        ...
        filterData() {
            api.get('/ict_data/activations/bb/input_output/' + this.start_date + '/' + this.end_date).then(response => {
