<template>
  <q-card-section>
    ...
    <div class="row q-col-gutter-x-sm q-pb-sm">
      <div class="col">
        <q-select v-model="tester_sn" :options="tester_serialnumbers" label="SN Tester" square @filter="filterTest"
          use-input input-debounce="0" :readonly="disabled" />
      </div>
      <div class="col">
        <q-select v-model="fixture_sn" :options="fixtures_sns" label="ID Fixtura" square @filter="filterFix" use-input
    ...
    <div class="row q-col-gutter-x-sm q-py-sm">
      <div class="col">
        <q-select v-model="event_type" :options="event_tps" label="Tipo de evento" square :readonly="disabled" />
      </div>
      <div class="col">
  ...
  <q-card-section v-if="updated_by != null">
    ...
    <div class="row">
      <div class="col">
        <q-input readonly v-model="updated_comments" type="textarea" rows="2" label="Comentarios de actualización" />
      </div>
    </div>
    <div class="row q-col-gutter-x-sm">
      <div class="col">
  ...
  <q-card-section class="q-pt-lg">
    <div class="float-right" v-if="status != 'Finalizado' && status != 'Cancelado'">
      ...
      <div v-if="this.current_user.rol == 'Administrador' || this.current_user.rol == 'M&C Full'">
