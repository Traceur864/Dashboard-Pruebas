...
import IndividualUtilization from './component/individualUtilization.vue';
...
export default {
    ...
    methods: {
        getData() {
            ...
            api.get('/ict_data/activations/bb/utilization').then(response => {
        ...
        filterData() {
            api.get('/ict_data/activations/bb/utilization/' + this.start_date + '/' + this.end_date).then(response => {
