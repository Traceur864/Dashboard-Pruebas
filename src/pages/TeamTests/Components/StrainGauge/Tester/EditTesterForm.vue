                    ...
                    <div class="col q-col-gutter-y-sm">
                        <div class="row q-col-gutter-x-sm">
                            <div class="col column justify-center">
                                <q-input v-model="edit_tester_name" square filled type="text" maxlength="255" label="Nombre del Tester" />
                            </div>
                        </div>

                        <div class="row q-col-gutter-x-sm">
                            <div class="col column justify-center">
                                <q-select square filled v-model="edit_model_tester" label="Modelo en el que se utiliza" :options="models" />
                            </div>
                            <div class="col column justify-center">
                                <q-select square filled v-model="edit_area_tester" label="Area en la que se encuentra" :options="areas" />
                            </div>
                        </div>
