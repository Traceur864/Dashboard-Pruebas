<template>
  <q-card-section>
    ...
    <div class="row q-col-gutter-x-sm">
      <div class="col">
        <q-select ref="tester_select" square v-model="tester_sn" label="SN del Tester" :options="tester_serialnumbers"
    ...
    <div class="row q-col-gutter-x-sm">
      <div class="col-3">
        <q-select flat v-model="asigned_to" label="Responsable de SG" :options="usuarios" @filter="filterUser" use-input
          input-debounce="0" />
      </div>
      <div class="col">
